...
- Project dossier and reference snippets no longer include the trailing `---`
  entry separator. An internal shared diary scanner now backs the
  read/analysis tools (no behaviour change).
...
[Unreleased]: https://github.com/mauriziomocci/mcp-cronos/compare/v1.6.1...HEAD
[1.6.1]: https://github.com/mauriziomocci/mcp-cronos/compare/v1.6.0...v1.6.1
[1.6.0]: https://github.com/mauriziomocci/mcp-cronos/compare/v1.5.0...v1.6.0
[1.5.0]: https://github.com/mauriziomocci/mcp-cronos/compare/v1.4.0...v1.5.0
